...
-   [`@stdlib/constants/float64/max-base2-exponent`][@stdlib/constants/float64/max-base2-exponent]: the maximum biased base 2 exponent for a double-precision floating-point number.
